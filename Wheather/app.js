...
switch(weather_data.weather[0].main){
        case 'Clouds':
            wheather_img.src="image/cloud.jpeg"
            break;
        case 'Clear':
            wheather_img.src="image/sunny.jpeg"  
            break;  
        case 'Rain':
            wheather_img.src="image/rain.jpeg"
            break;
        case 'Mist':
            wheather_img.src="image/wind.jpeg" 
            break;   
        case 'Snow':
            wheather_img.src="image/snow.jpeg"
           break;
    }
